...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00612FC0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x003B7040 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x003B44D0 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00EAB210 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x0121ABC0 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x00EBE7F0 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x003E3B80 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x003E3BE0 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x003B0A80 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x003EF4D0 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x00612FC0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x003E41E0 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x003A9A50 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x003B2130 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x0035B2B0 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x00EBE7F0 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x003E4B70 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x003E3600 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x003EC1F0 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x003E4C40 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x003E3AC0 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x003E3620 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x003E3AF0 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x00EBE7F0 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x00EBE7F0 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00D064A0 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x003E3610 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x003E3620 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x003E3AF0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x003E3620 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x003E3AF0 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x003EA100 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x003E4D30 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x003E4ED0 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x00EBE7F0 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x003A21E0 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x003F62D0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x00356BB0 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x003E3D40 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x00356BE0 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x00357520 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x0127BBC0 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x00D064A0 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00D064A0 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x00EBE7F0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x0127BBC0 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x00832190 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x008374F0 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x003A2270 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x003AD050 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x0121ABC0 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x003E4750 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x00388FA0 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x003B41C0 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x003E4830 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x01066100 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x003E3AA0 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x003E47A0 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x0035A8B0 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x003F5B00 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x0127BBC0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x00354CD0 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x00354CF0 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x003F94C0 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x003E3630 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x003B0970 (0x104)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x0039EAC0 (0x108)
};
