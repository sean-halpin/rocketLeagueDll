...
public:
	...
	struct FLoadingMovieMapInfo                        LoadingScreenInfo;                                		// 0x004C (0x0070) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	struct FPointer                                    VfTable_FCallbackEventDevice;                     		// 0x0088 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	unsigned long                                      bFakeMobileTouches : 1;                           		// 0x008C (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	unsigned long                                      bCaptureWorldRendering : 1;                       		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bCloseOnLevelChange : 1;                          		// 0x00C8 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bOnlyOwnerFocusable : 1;                          		// 0x00C8 (0x0004) [0x0000000000000000] [0x00001000] 
	unsigned long                                      bForceFullViewport : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bDiscardNonOwnerInput : 1;                        		// 0x00C8 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bCaptureInput : 1;                                		// 0x00C8 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bCaptureMouseInput : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00010000] 
	unsigned long                                      bIgnoreMouseInput : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00020000] 
	unsigned long                                      bIsSplitscreenLayoutModified : 1;                 		// 0x00C8 (0x0004) [0x0000000000002000] [0x00040000] ( CPF_Transient )
	unsigned long                                      bShowHardwareMouseCursor : 1;                     		// 0x00C8 (0x0004) [0x0000000000000000] [0x00080000] 
	unsigned long                                      bForceFullScreen : 1;                             		// 0x00C8 (0x0004) [0x0000000000000000] [0x00100000] 
	unsigned long                                      bBlurLesserMovies : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00200000] 
	unsigned long                                      bHideLesserMovies : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x00400000] 
	unsigned long                                      bIsPriorityBlurred : 1;                           		// 0x00C8 (0x0004) [0x0000000000000000] [0x00800000] 
	unsigned long                                      bIsPriorityHidden : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x01000000] 
	unsigned long                                      bIgnoreVisibilityEffect : 1;                      		// 0x00C8 (0x0004) [0x0000000000000000] [0x02000000] 
	unsigned long                                      bIgnoreBlurEffect : 1;                            		// 0x00C8 (0x0004) [0x0000000000000000] [0x04000000] 
	...
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                        		// 0x015C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      UnknownData03[ 0x4 ];                             		// 0x0160 (0x0004) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	int                                                SourceFileCRC;                                    		// 0x009C (0x0004) [0x0000000000020001]              ( CPF_Edit | CPF_EditConst )
	TArray< unsigned char >                            Editions;                                         		// 0x00A0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                RTTextures;                                       		// 0x00AC (0x0004) [0x0000000000000000]              
	int                                                RTVideoTextures;                                  		// 0x00B0 (0x0004) [0x0000000000000000]              
...
{
public:
	struct FScriptDelegate                             __EventListener__Delegate;                        		// 0x0078 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 37337 ];
